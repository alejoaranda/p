...
export const LandingPage: React.FC<LandingPageProps> = ({ onEnterApp }) => {
    ...
    useEffect(() => {
        ...
        const scrollLinks = document.querySelectorAll('.nav-link, .logo, .footer-links a, .footer-legal-links a, .cta-button');
        ...
        const showPlans = (planType: string) => {
            ...
            if (showMonthly) {
                ...
                setTimeout(() => {
                    (annualPlans as NodeListOf<HTMLElement>).forEach(card => card.style.display = 'none');
                    (monthlyPlans as NodeListOf<HTMLElement>).forEach(card => {
                ...
                setTimeout(() => {
                    (monthlyPlans as NodeListOf<HTMLElement>).forEach(card => card.style.display = 'none');
        ...
        toggleButtons.forEach(button => {
            button.addEventListener("click", function() {
                ...
                showPlans((this as HTMLElement).dataset.planType!);
            });
        });
        ...
        const closeModal = () => {
            ...
            trialModal.classList.remove("is-visible");
        };

        const openModal = () => {
            if (trialModal) trialModal.classList.add("is-visible");
        };
        ...
        languageOptions.forEach(option => {
            option.addEventListener('click', () => {
                ...
                setLanguage(lang);
                const dropdown = (option as HTMLElement).closest('.language-dropdown');
                    ...
                    <div className="container">
                        <nav className="nav">
                            ...
                            <ul className="nav-menu" id="nav-menu">
                                <li><a href="#features" className="nav-link" data-translate="nav_features">Características</a></li>
                                <li><a href="#pricing" className="nav-link" data-translate="nav_pricing">Precios</a></li>
                                <li><a href="#faq" className="nav-link" data-translate="nav_faq">FAQ</a></li>
                                <li><a href="#contact" className="nav-link" data-translate="nav_contact">Contacto</a></li>
                            </ul>
                            
                            <a href="#pricing" className="cta-button" data-translate="nav_cta">Prueba Gratis</a>
                    ...
                    <div className="container">
                        <div className="footer-content">
                            <div className="footer-section">
                                <a href="#home" className="logo" style={{color: 'white', marginBottom: '1rem'}}>
                                    <div className="logo-icon">C</div>
                                    <span>CostePro</span>
                                </a>
