...
const App: React.FC<AppProps> = ({ onEnterApp }) => {
    ...
    // Smooth scroll function for React onClick handlers
    ...
    useEffect(() => {
        const translations = {
            es: {
                ...
                faq3_a: "Al registrarte con tu cuenta de Google, obtienes acceso completo a CostePro Premium during 15 días. Para asegurar un uso justo, la prueba está limitada a una por dispositivo. Cuando termine el periodo, podrás elegir el plan que prefieras y todos los datos que hayas introducido se conservarán.",
        ...
        const openModalBtns = [document.getElementById("request-trial-btn"), document.getElementById("hero-trial-btn"), document.getElementById("nav-trial-btn")];
            ...
            <div className="landing-page-container">
                <header className="header" id="header">
                    <div className="container">
                        <nav className="nav">
                            <button className="logo" onClick={(e) => scrollToSection(e, 'home')}>
                                <div className="logo-icon">C</div>
                                <span>CostePro</span>
                            </button>
                            
                            <ul className="nav-menu" id="nav-menu">
                                <li><a href="#features" className="nav-link" onClick={(e) => scrollToSection(e, 'features')}>Características</a></li>
                                <li><a href="#pricing" className="nav-link" onClick={(e) => scrollToSection(e, 'pricing')}>Precios</a></li>
                                <li><a href="#faq" className="nav-link" onClick={(e) => scrollToSection(e, 'faq')}>FAQ</a></li>
                                <li><a href="#contact" className="nav-link" onClick={(e) => scrollToSection(e, 'contact')}>Contacto</a></li>
                            </ul>
                            
                            <button id="nav-trial-btn" className="cta-button" data-translate="nav_cta">Prueba Gratis</button>
                    ...
                    <div className="container">
                        <div className="footer-content">
                            <div className="footer-section">
                                <button className="logo" style={{color: 'white', marginBottom: '1rem'}} onClick={(e) => scrollToSection(e, 'home')}>
                                    <div className="logo-icon">C</div>
                                    <span>CostePro</span>
                                </button>
